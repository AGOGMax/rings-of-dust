...
| Number | Significance |
|--------|-------------|
| **11** | Fuel cell cycle duration. Day 11: one cell in 740 receives the one-time exterior Jackpot deposit. The sync period ends. Also the return interval from void sacrifices (gold asteroid every 11 days). |h
